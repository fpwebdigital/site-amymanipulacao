  ...
  <div class="container">
	<div class="row">
		<div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
			...
			<h1 class="estilo_texto_granco_cinza center"><i class="fa fa-envelope"></i> Contato</h1>
	  	...
	  	<div class="row">
			...
			<div class="col-sm-4 col-md-4 col-lg-4 col-xs-12">
				<div class="box_inputs left">
					...
					<label for="sim" class="estilo_texto_geral">Como gostaria de ser contatado?</label><br> 
					<input id="enviou" type="radio" name="gender" value="E-mail"></input>
      <label for="sim" class="estilo_texto_geral">E-mail</label>
      <input id="tel" type="radio" name="gender" value="Telefone">
      <label for="nao" class="estilo_texto_geral">Telefone</label>
      <input id="whats" type="radio" name="gender" value="WhatsApp"></input>
       <label for="nao" class="estilo_texto_geral">WhatsApp</label>
				</div>
